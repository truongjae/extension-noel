...
function bodyAdd(){
    document.body.appendChild(createElm("canvas","","bongbong",""));
    document.body.appendChild(createElm("div","cursor","",""));
    document.body.appendChild(createElm("div","cursor2","",""));
    document.body.appendChild(createElm("div","","onggianoel",""));
}
function get(elm){
    if(elm[0] == "#")
